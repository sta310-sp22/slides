...
- In a study measuring depression indices weekly over a month, the four measures for the same patient tend to be more similar than than depression indices from other patients
...
Correlation among outcomes within the same group (teacher, patient, household) is **intraclass correlation** 
...
Researchers are interested in understanding the effect social media has on opinions about a proposed economic plan. They random select 1000 households and ask each adult in the household how many minutes they spend on social media daily and whether they support the proposed economic plan.
...
The data are simulated results of an experiment with 24 dams (mother rats) randomly divided into four groups that received different doses of teratogen, a substance that could potentially cause harm to developing fetuses. The four groups are 
...
Each dam produces 10 rat pups and the presence of a deformity is noted. 
...
tibble(x = 1:24, pi_1b) %>%
  ggplot() +
    ...
    labs(title = "Probability of derformity", 
...
- The structure of the data set may imply correlation among observations. 

- Correlated observations provide less information than independent observations; we need to account for this difference

- Failing to account for this difference could result in underestimating standard error, thus resulting in overstating significance and the precision of the estimates 
