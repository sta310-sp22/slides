...
library(viridis)
ggplot(data = derby, aes(x = year, y = speed, color = condition, shape = condition, linetype = condition)) + 
  geom_point() + 
  geom_smooth(method = "lm", se = FALSE, aes(lty = condition)) + 
...
**Interpreting the effect of `year`**
...
## Model 3: Interaction between `year` and `condition`
...
- Which is most meaningful in practice?
...
## Model 1 stats + limitations

## Model 2 stats + limitations

## Model 3 stats + limitations 
