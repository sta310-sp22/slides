...
- In reality $\hat{\sigma}^2$ must be non-negative, so the search for the MLE is restricted to the region such that $\sigma^2 \geq 0$. 
...
- Remove variance and correlation terms estimated at the boundary 

- Reduce the number of parameters to be estimated by fixing the values of some  
