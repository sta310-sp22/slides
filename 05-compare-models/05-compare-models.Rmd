...
.footnote[
[Click here](05-model2-mle.pdf) for details on finding MLEs for this model.]
...
`r emo::ji("four")`  Use Likelihood Ratio Test to determine if the difference is statistically significant 
